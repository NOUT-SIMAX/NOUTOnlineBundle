<?php
namespace NOUT\Bundle\NOUTOnlineBundle\SOAP\NUSOAP;
/**
 * Created by PhpStorm.
 * User: Ninon
 * Date: 22/07/14
...
class NUSOAPServer extends NUSOAPBase {
	...
	function serialize_return() {
		// if fault
		if (isset($this->methodreturn) && is_object($this->methodreturn) && ((get_class($this->methodreturn) == 'SOAPFault') || (get_class($this->methodreturn) == 'NUSOAPFault'))) {
